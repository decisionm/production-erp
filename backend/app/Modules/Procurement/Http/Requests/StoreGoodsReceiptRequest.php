...
class StoreGoodsReceiptRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'lines.*.unit_cost' => ['nullable', 'numeric', 'min:0', new PlainDecimal],
            ...
            'lines.*.schedule_allocations.*.quantity' => ['required_with:lines.*.schedule_allocations', 'numeric', 'gt:0', new PlainDecimal],
            ...
            'lines.*.lots.*.bag_weight_kg' => ['nullable', 'numeric', 'gt:0', new PlainDecimal],
            'lines.*.lots.*.total_received_kg' => ['nullable', 'numeric', 'gt:0', new PlainDecimal],
            ...
            'lines.*.lots.*.bag_weights.*' => ['required', 'numeric', 'gt:0', new PlainDecimal],
