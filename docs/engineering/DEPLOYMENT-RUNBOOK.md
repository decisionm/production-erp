...
| 10 | Phase 5.7 Shift Summary + CEC infra (PR TBD) | #187 | none | none | Shift Summary report gains additive honesty keys (old keys aliased); `GET production/cec` (data only; format BLOCKED; export slot unchanged 409); Shift Summary page reconcile line + CEC preview (no download) |
