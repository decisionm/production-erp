...
PHASE 7.5 Store → Production material flow     PASS (re-gate zero findings) · PR #192 (stacked on #191) · three states never collapse · Q54
...
PHASE 8   END-TO-END ACCEPTANCE                 **NOT READY** · PR #193 (stacked on #192) · 4 chains PASS · D-WIRING NOT TESTED (7.6 wired no entity) · CEC + Q35(d) BLOCKED · no browser proof, SQLite only
──────────────────────────────────────────────────────────────────────
