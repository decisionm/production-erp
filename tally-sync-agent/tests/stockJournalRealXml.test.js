...
// ---------------------------------------------------------------------------
// PENDING Q92 — the three vouchers that are NOT shift production.
// ---------------------------------------------------------------------------

/**
 * Three of the export's 34 are not shift production, and what they ARE is an
 * open owner question (Q92). Until it is answered the case is held FAIL-CLOSED:
 ...
 */
test('a production journal has BOTH sides — the predicate Q92 holds the line on', () => {
